  ...
  <body>  
      ...
      <nav class="navbar navbar-expand-md navbar-light bg-light">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <li>
              <a class="nav-link active fst-italic fw-bold" aria-current="page" href="aboutus.html">About Us</a>
            </li>
            <li>
    ...
    <main style="margin-top: 200px;">
      <div class="container mt-5">
        <div class="row mb-3">
          <div class="col-md-12" id="whoWeAre">
            <h3 class="text-warning">WHO WE ARE</h3><hr class="mb-3">
            <ul>
              <li>International</li>
        ...
        <div class=" row mt-5" id="our-team" style="scroll-margin-top:150PX;">
          <h1 class="text-warning text-center">Our Team</h1><hr class="mb-5">
          ...
          <div class="row">
            <div class="col-md-2 mb-3">
              ...
              <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="resource_library.html" class="nav-link p-0 text-muted">Resources
                    Library</a></li>
            ...
            <div class="col-md-8 offset-md-1 mb-1">
              <form action="" method="post">
                ...
                <div class="row">
                  <div class="form-group mb-3 col-md-6">
                    ...
                    <select name="category" id="category" class="form-control"
                      aria-placeholder="Select means of contact:By Email">
                      <option value=""></option>
                  ...
                  <div class="form-group mb-3 col-md-6">
                    <label for="category">You can be</label>
                    <select name="category" id="category" class="form-control" placeholder="Prayer Partner">
                      <option value=""></option>
                ...
                <button type="submit" name="bePartOfUs" class="btn btn-primary col-md-12">
                  Join Us: Let impact into our generation and beyond
                </button>
              </form>
            </div>
          </div>
